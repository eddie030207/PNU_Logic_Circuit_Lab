...
HD_PWD='E:/xilinx_project/week9_1/week9_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week10_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week10_1.tcl
