...
HD_PWD='E:/xilinx_project/week9_1/week9_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week10_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week10_1.tcl -notrace
