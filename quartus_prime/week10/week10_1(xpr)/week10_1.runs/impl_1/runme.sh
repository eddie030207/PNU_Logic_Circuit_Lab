...
HD_PWD='E:/xilinx_project/week10_1/week10_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week11.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week11.tcl -notrace
