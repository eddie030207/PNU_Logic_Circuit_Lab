...
HD_PWD='E:/xilinx_project/week7_2/week7_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log work2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source work2.tcl
