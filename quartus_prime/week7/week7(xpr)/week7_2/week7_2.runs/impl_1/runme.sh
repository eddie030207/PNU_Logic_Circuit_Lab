...
HD_PWD='E:/xilinx_project/week7_2/week7_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log work2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source work2.tcl -notrace
